-- sql/migrations/005_frontmatter_links_revisions.sql — module m6. concept_frontmatter (1:1 OKF
-- YAML frontmatter), concept_links (resolved cross-links), and concept_revisions (immutable
-- snapshot history). Transcribed verbatim from Database.md's "## DDL" block.
